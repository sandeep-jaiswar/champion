...
class TestSchemaValidation:
    ...
    def test_validate_schema_normalized_with_nse_names(
        self, loader, sample_normalized_df_nse_names
    ):
...
class TestColumnMapping:
    ...
    def test_column_mapping_normalized_friendly_to_nse(
        self, loader, sample_normalized_df_friendly_names
    ):
        """Test that friendly column names are mapped to NSE names."""
        result = loader._prepare_dataframe_for_insert(
            sample_normalized_df_friendly_names, "normalized_equity_ohlc"
        )
    ...
    def test_column_mapping_normalized_nse_names_unchanged(
        self, loader, sample_normalized_df_nse_names
    ):
        """Test that NSE names are kept as-is (no unnecessary mapping)."""
        result = loader._prepare_dataframe_for_insert(
            sample_normalized_df_nse_names, "normalized_equity_ohlc"
        )
