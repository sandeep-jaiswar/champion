...
from src.corporate_actions.ca_processor import (
...
class TestCorporateActionsProcessor:
    ...
    def test_compute_split_adjustment_1_to_5(self):
        ...
        factor = self.processor.compute_split_adjustment(
    ...
    def test_compute_split_adjustment_invalid(self):
        ...
        with pytest.raises(ValueError):
            self.processor.compute_split_adjustment(
                old_shares=1, new_shares=-5
            )
    ...
    def test_compute_bonus_adjustment_1_to_2(self):
        ...
        factor = self.processor.compute_bonus_adjustment(
    ...
    def test_compute_bonus_adjustment_1_to_1(self):
        ...
        factor = self.processor.compute_bonus_adjustment(
            new_shares=1, existing_shares=1
        )
    ...
    def test_compute_bonus_adjustment_invalid(self):
        ...
        with pytest.raises(ValueError):
            self.processor.compute_bonus_adjustment(
                new_shares=0, existing_shares=2
            )
    ...
    def test_compute_dividend_adjustment(self):
        ...
        factor = self.processor.compute_dividend_adjustment(
            dividend_amount=10.0, close_price=100.0
        )
        assert factor == 0.9
    ...
    def test_compute_dividend_adjustment_small(self):
        ...
        factor = self.processor.compute_dividend_adjustment(
            dividend_amount=2.0, close_price=100.0
        )
        assert factor == 0.98
    ...
    def test_compute_dividend_adjustment_invalid(self):
        ...
        with pytest.raises(ValueError):
            self.processor.compute_dividend_adjustment(
                dividend_amount=-10.0, close_price=100.0
            )

        with pytest.raises(ValueError):
            self.processor.compute_dividend_adjustment(
                dividend_amount=10.0, close_price=0.0
            )
...
class TestCorporateActionIntegration:
    ...
    def test_realistic_split_scenario(self):
        ...
        split_factor = processor.compute_split_adjustment(
            old_shares=1, new_shares=5
        )
    ...
    def test_realistic_bonus_scenario(self):
        ...
        bonus_factor = processor.compute_bonus_adjustment(
            new_shares=1, existing_shares=2
        )
